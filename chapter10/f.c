/*There are three pegs labeled A, B and C. Four disks are placed on 
  pegA. The bottom-most disk is largest, and disks go on decreasing 
  in size with the top most disk being the smallest. The objective of 
  the game is to move the disk from pegA to pegC, using pegB as an 
  auxillary peg. The rules of the game are as follows:
