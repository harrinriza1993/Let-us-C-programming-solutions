...
Apporach:
	1) Check the given range of numbers divisiblity using modulo operator
	2) If the number divisible either by 1 or the same number then it is a prime number
*/
